    ...
    <form className="reviews__form form" action="" onSubmit={handleSubmit} >
      ...
      <div className="reviews__button-wrapper">
        <p className="reviews__help">
          To submit review please sign in, make sure to set <span className="reviews__star">rating</span> and describe your stay with at least <b className="reviews__text-amount">50 characters (but not more than 300 characters)</b>.
        </p>
        <button className="reviews__submit form__submit button" type="submit" disabled={rating === '' || reviewText.length < 50 || isAuthorized !== AuthorizationStatus.Auth || reviewText.length > 300} >Submit</button>
      </div>
    </form>
  );
}
